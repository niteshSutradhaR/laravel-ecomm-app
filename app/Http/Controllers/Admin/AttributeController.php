...
class AttributeController extends BaseController 
{
	...
	public function update(Request $request)
	{
		...
		if (!$attribute) 
		{
			$this->responseRedirectBack('Error occurred while updating Attribute','error',true,true);
		}

		return $this->responseRidrect('admin.attributes.index','success',false, false);
	}
