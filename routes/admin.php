	...
	Route::group(['prefix'=>'admin'], function(){
		...
		Route::group(['middleware' => ['auth:admin']], function () {
			...
			Route::group(['prefix'=>'categories'],function(){
				...
				Route::post('/upadte','Admin\CategoryController@update')->name('admin.categories.update');
				Route::get('/delete','Admin\CategoryController@delete')->name('admin.categories.delete');
			});
