            ...
            <div class="row">
                <div class="col-3">
                    @if (Setting::get('site_logo') != null)
                        <img src="{{ asset('storage/'.confSetting::get('site_logo')) }}" id="logoImg" style="width: 80px; height: auto;">
                    @else
            ...
            <div class="row mt-4">
                <div class="col-3">
                    @if (Setting::get('site_favicon') != null)
                        <img src="{{ asset('storage/'.confSetting::get('site_favicon')) }}" id="faviconImg" style="width: 80px; height: auto;">
                    @else
